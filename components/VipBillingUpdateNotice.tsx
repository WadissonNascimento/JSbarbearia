    ...
    >
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <Link
          ...
          className="inline-flex min-h-11 shrink-0 items-center justify-center gap-2 rounded-xl bg-[#e5e5e5] px-4 text-sm font-bold text-[#080808] transition hover:bg-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-amber-200"
        >
          Atualizar dados
