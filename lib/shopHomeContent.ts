...
export const DEFAULT_PUBLIC_HOME_CONTENT: PublicHomeContent = {
  ...
  secondaryButtonLabel: "Ver serviços",
  secondaryButtonHref: "/servicos",
  infoOneLabel: "Local",
  infoOneValue: "Endereço sob consulta",
  infoTwoLabel: "Horário",
  infoTwoValue: "Horário sob consulta",
  infoThreeLabel: "Atendimento",
  infoThreeValue: "Com hora marcada",
  showServices: true,
  servicesEyebrow: "Serviços",
  servicesTitle: "Escolha seu atendimento.",
  servicesDescription: "Veja os serviços disponíveis e avance para o agendamento.",
  showBarbers: true,
  ...
  aboutBody:
    "Atendimento com hora marcada, cuidado nos detalhes e uma experiência pensada para você sair satisfeito.",
  showContact: true,
