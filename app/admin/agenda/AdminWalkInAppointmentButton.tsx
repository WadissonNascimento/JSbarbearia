                            ...
                            <div className="sticky bottom-0 -mx-5 -mb-5 border-t border-white/10 bg-[#050b16]/95 p-4 backdrop-blur-xl">
                              <div className="flex items-center justify-between gap-3 rounded-2xl border border-[var(--brand)]/45 bg-[linear-gradient(135deg,rgba(200,200,200,0.95),rgba(140,140,140,0.95))] px-4 py-3 text-[#080808] shadow-[0_18px_40px_rgba(0,0,0,0.35)]">
                                ...
                                <button
                                  ...
                                  className="inline-flex min-h-11 shrink-0 items-center justify-center gap-2 rounded-xl border-2 border-white bg-white px-5 py-2 text-sm font-black text-[#141414] shadow-[0_8px_20px_rgba(0,0,0,0.22)] transition hover:bg-[#f7f7f7] active:scale-[0.98]"
                                >
                                  Continuar
