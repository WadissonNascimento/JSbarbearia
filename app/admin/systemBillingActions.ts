...
import { SYSTEM_BILLING_OWNER_EMAIL, isSystemBillingConfigured } from "@/lib/systemBilling";
...
export async function markSystemBillingPaymentPaidAction(
  ...
  if (!isSystemBillingConfigured() || !userEmail || userEmail !== SYSTEM_BILLING_OWNER_EMAIL) {
    return {
      ok: false,
      message:
