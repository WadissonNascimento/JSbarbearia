                  ...
                  return (
                    <button
                      ...
                      className={`min-w-0 rounded-xl border px-2.5 py-2 text-left transition sm:w-full sm:px-3 ${
                        checked
                          ? "border-[var(--brand)] bg-[var(--brand-muted)] text-white shadow-[0_18px_36px_rgba(200,200,200,0.18)]"
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          <Link
                            ...
                            className="mt-3 inline-flex min-h-10 items-center justify-center rounded-xl bg-[#e5e5e5] px-4 text-sm font-black text-[#080808] transition hover:bg-white"
                          >
                    ...
                    <div className="min-w-0">
                      <p
                        className={`inline-flex items-center gap-2 text-xs font-black uppercase tracking-[0.18em] ${
                          useVipPlan ? "text-emerald-200" : "text-[#dedede]"
                        }`}
                      >
                        {useVipPlan ? (
                      ...
                      <button
                        ...
                        className={`inline-flex min-h-11 items-center justify-center gap-2 rounded-xl px-4 text-sm font-black transition disabled:cursor-not-allowed disabled:bg-white/10 disabled:text-zinc-500 ${
                          useVipPlan
                            ...
                            : "bg-[#e5e5e5] text-[#080808] hover:bg-white"
                        }`}
                      >
                        {useVipPlan ? (
                          <>
    ...
    <div className="fixed inset-x-0 bottom-0 z-[9000] border-t border-white/10 bg-[#050b16]/95 px-4 pb-[calc(env(safe-area-inset-bottom)+0.75rem)] pt-3 text-white shadow-[0_-16px_50px_rgba(0,0,0,0.45)] backdrop-blur-md md:hidden">
      <div className="mx-auto flex max-w-5xl items-center gap-3">
        ...
        <button
          type="button"
          onClick={onContinue}
          className="shrink-0 rounded-2xl bg-[var(--brand)] px-5 py-3 text-sm font-bold text-white shadow-[0_14px_30px_rgba(200,200,200,0.28)] transition hover:brightness-110"
        >
          Continuar
        </button>
      </div>
    ...
    >
      <div className="w-full max-w-md rounded-2xl border border-amber-300/35 bg-[#050b16] p-5 text-white shadow-[0_24px_80px_rgba(0,0,0,0.6)]">
        ...
        <button
          type="button"
          onClick={onClose}
          className="mt-5 min-h-11 w-full rounded-xl bg-[#e5e5e5] px-4 py-3 text-sm font-black text-[#080808] transition hover:bg-white"
        >
          Entendi
        </button>
      </div>
  ...
  return createPortal(
    <>
      ...
      {isPunctualityDialogOpen ? (
        ...
        >
          <div className="w-full max-w-sm rounded-3xl border border-amber-300/25 bg-[#0b0b0b] p-5 text-white shadow-[0_28px_90px_rgba(0,0,0,0.68)]">
            ...
            <div className="mt-6 grid gap-3 sm:grid-cols-2">
              ...
              <button
                ...
                disabled={isSubmitting}
                className="min-h-12 rounded-2xl border border-amber-200/30 bg-[var(--brand)] px-4 py-3 text-sm font-black text-white shadow-[0_14px_34px_rgba(200,200,200,0.22)] transition hover:brightness-110 disabled:cursor-not-allowed disabled:opacity-60"
              >
                Entendi e confirmar
              </button>
            </div>
