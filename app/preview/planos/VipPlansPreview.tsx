...
export default function VipPlansPreview() {
  ...
  return (
    <main className="min-h-screen bg-[#050505] px-4 py-6 text-[#f5f5f5] sm:px-6">
      <div className="mx-auto max-w-5xl space-y-5">
        ...
        <div className="overflow-hidden rounded-2xl border border-[#c8c8c8]/25 bg-[#0b0b0b]">
          <header className="border-b border-[#c8c8c8]/15 bg-[linear-gradient(135deg,_rgba(200,200,200,0.18),_rgba(8,8,8,0.98))] p-5 sm:p-7">
            <p className="inline-flex items-center gap-2 text-xs font-black uppercase tracking-[0.2em] text-[#dedede]"><Crown className="h-4 w-4" aria-hidden="true" />Área VIP</p>
            <h1 className="mt-4 text-3xl font-black sm:text-4xl">Olá, Cliente! Seu plano é Ouro.</h1>
            <p className="mt-3 flex items-center gap-2 text-sm text-[#c2c2c2]"><Scissors className="h-4 w-4" aria-hidden="true" />Corte + Sobrancelha + Barba · 4 usos mensais</p>
          </header>
