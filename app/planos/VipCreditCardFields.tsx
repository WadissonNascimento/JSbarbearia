export default function VipCreditCardFields() {
  const inputClass = "min-h-11 min-w-0 rounded-lg border border-white/15 bg-black/30 px-3 text-base text-white outline-none transition focus:border-[#dedede] sm:text-sm";
  const labelClass = "grid min-w-0 gap-1.5 text-xs font-bold text-[#f5f5f5] sm:gap-2 sm:text-sm";
