...
const GLOBAL_RELOAD_FLAG = "js-barbearia-global-error-reload-v1";
      ...
      <body className="min-h-screen bg-[#080808] text-white">
        <main className="flex min-h-screen items-center justify-center px-5">
          <section className="w-full max-w-md rounded-[28px] border border-white/10 bg-white/[0.04] p-6 text-center shadow-[0_24px_70px_rgba(0,0,0,0.35)]">
            <p className="text-xs uppercase tracking-[0.28em] text-[#dedede]">
              Sistema
            </p>
            ...
            <div className="mt-6 grid gap-3">
              <button
                ...
                className="rounded-2xl bg-[#c8c8c8] px-5 py-3 font-semibold text-[#080808]"
              >
                Tentar novamente
              </button>
              <a
